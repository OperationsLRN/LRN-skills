...
| Extract deterministic helpers before calling AI for iam-advisor. | Parsing, validation, routing, and manifests are cheaper and safer as pure functions. | FUNCTIONS.md classification |
