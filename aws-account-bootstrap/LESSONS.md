# Lessons Learned — aws-account-bootstrap
...
| Extract deterministic helpers before calling AI for aws-account-bootstrap. | Parsing, validation, routing, and manifests are cheaper and safer as pure functions. | FUNCTIONS.md classification |
